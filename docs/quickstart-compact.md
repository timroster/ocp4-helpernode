# Helper Node Quickstart Compact Install
...
Create (but do NOT install) 3 empty VMs. Please follow the [min requirements](https://docs.openshift.com/container-platform/4.2/installing/installing_bare_metal/installing-bare-metal.html#minimum-resource-requirements_installing-bare-metal) for these VMs.
...
for i in master{0..2}
do
  virt-install --name="ocp4-${i}" --vcpus=8 --ram=32768 \
